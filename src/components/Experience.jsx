...
// Hopefully I can uncomment these two below soon! 🤓
...
export const Experience = () => {
  ...
  return (
     <div name='experience' className='bg-gradient-to-b from-gray-800 to-black w-full h-screen'>
        <div className='max-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-white'>
            <div className='border-gray-500 p-2 inline'>
