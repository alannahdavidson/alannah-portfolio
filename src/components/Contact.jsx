   ...
   <div name='contact' className='w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white'>
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            ...
            <div className='flex justify-center items-center'>
                <form 
                action="https://getform.io/f/135f808a-d7e2-4233-8c0f-f994216c26a7" 
                className='flex flex-col w-full md:w-1/2' method='POST'>
                    ...
                    <button className='text-white bg-gradient-to-r from-indigo-400 to-purple-400 px-6 py-3 my-8 mx-auto flex-items-center rounded-md hover:scale-110 duration-300'>Let's Talk</button>
                </form>
            </div>
        </div>
    </div>
